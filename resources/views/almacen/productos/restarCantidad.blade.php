            ...
            <div class="row justify-content-center">
                <div class="col-sm-12 col-lg-7">
                    <div id="" class="card card2 ">
                        ...
                        <form action="/almacen/restar/{{ $producto->id }}" method="post">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 mt-4">
                                        <div class="form-group">
                                            <strong><label class="bmd-label-floating" for="cantidad">Restar cantidad {{ $producto->cantidad }}</label></strong>
                                        <input required class="form-control " type="number" name="cantidad" value="{{ old('cantidad') }}">
                                   ...
                                   <div class="col-lg-6 col-md-12 mt-4">
                                        <div class="form-group">
                                            <strong><label class="bmd-label-floating" for="motivo">Motivo</label></strong>
                                            <input required class="form-control {{ $errors->has('motivo') ? ' is-invalid' : '' }}" type="text" name="motivo" value=" @if($q > 0) {{$motivo}} @endif">
