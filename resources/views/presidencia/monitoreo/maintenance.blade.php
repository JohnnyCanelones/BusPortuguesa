        ...
        <div class="col-sm-12 col-lg-7">
            ...
            <div id="" class='card card2'>
                ...
                <div class="card-header">
                    <h3 id="hola" class="azul text-center m-3 ">Monitoreo de Mantenimiento</h3>
                </div>
                <div class="card-body">
...
{{-- Modal --}}
<div class="modal fade" id="exampleModalLong2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" style="z-index: 1000000000000000000000000;">
  <div class="modal-dialog" role="document" style="top: 20%">
    <div class="modal-content text-center">
      <div class="modal-header text-center mb-2 p-2 " style="display: block; background-color: #008a34">
        ...
        <h5 class="modal-title text-white" id="exampleModalLongTitle2"></h5>
      </div>
...
<script type="text/javascript" src="{{ asset('js/presidencia/monitoreoMantenimiento.js') }}"></script>
