                    ...
                    notificaciones.innerHTML = "" 
                        for (let i = 0; i < data[1]; i++) {
                            ...
                            notificaciones.innerHTML += `
                                ...
                                <div class="card-header ml-2 text-right" style="height:5px;"><a style="color:#003286;" data-toggle="tooltip" data-placement="bottom" title="Borrar notificación" href="#" class="deleteNotificacion" onclick="" data-value="${dataw[i].id}">
