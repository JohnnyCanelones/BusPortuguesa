            ...
            <div class="row justify-content-center">
                <div class="col-sm-12 col-lg-7">
                    <div id="" class="card card2 ">
                      ...
                      <form action="/mantenimiento/update/servicio/{{$mantenimiento->id}}" method="post">
                        <div class="card-body">
                                {{ csrf_field() }}
                                <div class="row">
                                    {{-- formulario --}}
                                    <div class="col-lg-6 col-md-12  mt-4" id="fecha_inactivo">
                                        ...
                                        <input required  class="form-control "  name="fecha" id="date" value="{{ $mantenimiento->fecha }}">
                                    ...
                                    <div class="col-lg-6 col-md-12 mt-4">
                                        <div class=" form-group" >
                                             ...
                                             <option value="{{ $mantenimiento->bus_id }}">{{ $mantenimiento->bus_id }}</option>
                                    ...
                                    <div class="col-md-12 col-lg-6 mt-3">
                                      <div class="form-group">
                                          <select required="" class="tipo_mantenimiento form-control mt-1 focus" name="tipo_mantenimiento" required="">
                                                <option value=""></option>
                                                <option selected value="{{$mantenimiento->tipo_mantenimiento }}">{{ $mantenimiento->tipo_mantenimiento }}</option>
                                    ...
                                    <div class="col-md-12  col-lg-12 mt-5" id="mecanicos">
                                        <div class="" >
                                            <select  multiple class="mecanicos form-control mt-1 focus"  name="mecanicos[]" required="" >
                                                ...
                                                @foreach ($mantenimiento->staffs as $mecanicoSelected)
                                                <option selected   value="{{ $mecanicoSelected->id }}">C.I {{ $mecanicoSelected->id }}, <br>{{ $mecanicoSelected->names }} {{ $mecanicoSelected->last_names }}</option>
                                                ...
                                                @forelse($mecanicos as $mecanico)
                                                  ...
                                                  @empty
                                                  <optgroup label="No hay más Mecanicos">
                                                  @endforelse
