...
<form action="/mantenimiento/bus/{{$mantenimientos[0]->bus_id}}/pdf?tipo_servicio={{$mantenimientos[0]->tipo_servicio}}" method="post" class="m-0" target="_blank">
  <div class="">
    {{ csrf_field() }}
                            @method('get')
    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-md-12 " id="fecha_inactivo">
          ...
          <input required  class="form-control "  name="desde" id="date" value="">
      ...
      <div class="col-lg-5 col-md-12 " id="fecha_inactivo">
          ...
          <input required  class="form-control "  name="hasta" id="date2" value="">
