  ...
  <div class="modal-dialog" role="document" style="top: 20%">
    <div class="modal-content text-center">
      <div class="modal-header text-center mb-2 p-2 " style="display: block; background-color: #008a34">
        ...
        <h5 class="modal-title text-white" id="exampleModalLongTitle">Agregar nuevo modelo</h5>
      </div>
      <div class="modal-body">
        ...
        <div class="row">
        	<div class="col-sm-12">
	        	...
	        	<form id="servicio" action="/mantenimiento/buses/nuevo/modelo" onkeypress="return anular(event)" method="post">
					{{ csrf_field() }}
	        		<div class="row">
									<div class="col-sm-12">
...
<script type="text/javascript">
		...
		let submit = document.getElementById('submit')
  		submit.addEventListener('click', function(ev){
  			...
  			$.ajax({
			    type: "POST",
			    url: '/mantenimiento/buses/nuevo/modelo',
			    data: {  _token: '{{csrf_token()}}', name: x },
