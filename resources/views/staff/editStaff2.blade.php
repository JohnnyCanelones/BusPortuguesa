    ...
    <div class="row justify-content-center">
        <div class="col-sm-12 col-lg-7">
			<div id="" class="card card2 ">
				...
				<form action="/personal/me/{{ $staff->id }}" method="post">
				<div class="card-body">
						{{ csrf_field() }}
						<div class="row">
							{{-- formulario --}}
							<div class="col-lg-6 col-md-12 mt-3 " >
								<div class="form-group">
									...
									<select disabled required name="nacionality" class="form-control  focus  {{ $errors->has('nacionality') ? ' is-invalid' : '' }}">
							...
							<div class="col-lg-6 col-md-12 mt-5">
								<div class="form-group">
									...
									<select disabled="" required class=" js-example-basic-single form-control focus  {{ $errors->has('genre') ? ' is-invalid' : '' }}"  name="genre" value="{{ old('genre') }}">
										<option></option>
									...
									<div class="row">
										<div class="col-sm-10 mt-3">
											<div class="form-group">
												...
												<select disabled="" required="" class="js-example-basic-single form-control focus "  name="position" id="position" >
