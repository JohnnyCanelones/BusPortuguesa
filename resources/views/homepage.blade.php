...
<!-- <link href="../../Documents/Plugins/bootstrap.min.css"> -->
  <!-- Libraries CSS Files -->
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto"><i class="fa fa-bus"></i> BUS PORTUGUESA</a></h1>
        <!-- <img class="align-middle" src="../logo_gobierno_de_portuguesa_200x150aaaaa.png" style="max-width: 10%;"> -->
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          @else
            ...
            @endif
          @endguest
          <!-- <li><a href="#">Jefe de Mantenimiento</a></li> -->
          <!-- <li><a href="#">Carlos Escalona</a></li> -->
        </ul>
    ...
    <div class="intro-container">
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="{{ asset('homepage/img/intro-carousel/4.jpg') }}" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="{{ asset('homepage/img/intro-carousel/5.jpg') }}" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div class="member">
              <img src="{{ asset('homepage/img/team-3.jpeg') }}" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Lysmar Rangel</h4>
...
<!-- <link href="../../Documents/Plugins/bootstrap.min.js"> -->
